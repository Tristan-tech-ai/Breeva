...
import {
  ...
  TreePine, Activity, Clock, Radio, ShieldCheck, Radar, Trees,
} from 'lucide-react';
...
interface MapLayersSheetProps {
  ...
  showPOIs: boolean;
  onPOIsToggle: () => void;
  showGreenHighlight: boolean;
  onGreenHighlightToggle: () => void;
          ...
          >
            ...
            <div className="px-5 pt-4 pb-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5 leading-tight">
                      Restaurants, parks & eco merchants
                    </p>
                  </div>
                </button>
                ...
                {/* Ruang Hijau (green-space highlight) toggle */}
                <button
                  onClick={onGreenHighlightToggle}
                  className={`
                    flex flex-col items-start gap-2 p-3.5 rounded-2xl border-2 transition-all text-left
                    ${showGreenHighlight
                ...
                >
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center"
                    style={{ backgroundColor: showGreenHighlight ? '#16a34a18' : undefined }}>
                    <Trees className="w-4.5 h-4.5" style={{ color: showGreenHighlight ? '#16a34a' : '#9ca3af' }} />
                  </div>
                  <div>
                    <p className={`text-sm font-semibold ${showGreenHighlight ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'}`}>
                      Ruang Hijau
                    </p>
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5 leading-tight">
                      Sorot taman & area hijau
                    </p>
                  </div>
                </button>
              </div>
